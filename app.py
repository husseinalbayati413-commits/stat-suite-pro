...
st.markdown("## 🎯 قصتنا (Our Story)")
st.info("نحن نؤمن بأن التحليل الإحصائي المتقدم المعقد يجب أن يكون متاحاً وسهلاً للجميع. صُممت هذه المنصة لتكون 'AI Statistical & Research Assistant' (مساعدك البحثي والإحصائي الذكي)؛ لترافقك من خطوة رفع البيانات وتوضيح الأخطاء فيها، مروراً بالتحليل، وصولاً إلى استخراج التقرير الأكاديمي، دون الحاجة لكتابة كود واحد أو إضاعة وقتك في واجهات برامج معقدة.")

st.markdown("## 📌 ملاحظات مهمة")
st.info(
    "• المنصة مصممة بتقنيات متجاوبة بالكامل لتعمل من المتصفح ومن الهاتف بسهولة.\n"
    "• خصوصيتك مضمونة: لا يتم حفظ أي ملفات ترفعها على خوادمنا.\n"
    "• يمكنك تحميل النتائج والرسوم البيانية بدقة عالية للاستخدام الأكاديمي المباشر."
)
